...
{
    /// <summary>
    /// Provides unit testing methods for the <see cref="VanEmdeBoasTree"/> class.
    /// </summary>
    [TestClass]
    public class VanEmdeBoasTreeTests
    {
        /// <summary>
        /// Tests the <see cref="VanEmdeBoasTree"/> class against a
        /// test case from the CLRS book in Figure 20.6 on page 548, with
        /// the goal of ensuring that the
        /// <see cref="VanEmdeBoasTree.Member(int)"/> method works.
        /// </summary>
        [TestMethod]
        ...
        /// test case from the CLRS book in Figure 20.6 on page 548, with
        /// the goal of ensuring that the
        /// <see cref="VanEmdeBoasTree.Predecessor(int)"/> method works.
        /// </summary>
        [TestMethod]
        public void VanEmdeBoasTree_CLRS_Book_PredecessorTest()
        {
            // Arrange.
            IReadOnlyList<int> values = TestData.Get_CLRS_Figure20_6_Values();
            const int universe = 16;
        ...
        /// test case from the CLRS book in Figure 20.6 on page 548, with
        /// the goal of ensuring that the
        /// <see cref="VanEmdeBoasTree.Successor(int)"/> method works.
        /// </summary>
        [TestMethod]
